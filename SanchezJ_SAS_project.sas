...
DATE: Wednesday, January 07, 2015     TIME: 3:36:56 PM
PROJECT: SanchezJ_SAS_project_Jan72015
PROJECT PATH: P:\QAC\qac200\students\jrsanchez\SanchezJ_SAS_project_Jan72015.egp
---------------------------------------- */
...
%LET _CLIENTPROJECTPATH='P:\QAC\qac200\students\jrsanchez\SanchezJ_SAS_project_Jan72015.egp';
%LET _CLIENTPROJECTNAME='SanchezJ_SAS_project_Jan72015.egp';
...
/* -------------------------------------------------------------------
   ...
   Generated on: Wednesday, January 07, 2015 at 3:29:13 PM
...
PROC DATASETS NOLIST NODETAILS; 
   CONTENTS DATA=QACDATA.ASSING1_MEPS_FULLYR_2012_SAS7 OUT=WORK.SUCOUT1;

RUN;

DATA WORK.CONTContentsForASSING1_MEPS_FULL(LABEL="Contents Details for ASSING1_MEPS_FULLYR_2012_SAS7");
   SET WORK.SUCOUT1;
RUN;
...
CREATE VIEW WORK.SCVIEW AS 
	SELECT DISTINCT memname LABEL="Table Name", 
			...
			typemem LABEL="Data Set Type" FROM WORK.CONTContentsForASSING1_MEPS_FULL
	ORDER BY memname ; 

CREATE TABLE WORK.SCTABLE AS
	SELECT * FROM WORK.SCVIEW
		WHERE memname='ASSING1_MEPS_FULLYR_2012_SAS7';
QUIT;
...
PROC SORT DATA=WORK.CONTContentsForASSING1_MEPS_FULL OUT=WORK.CONTContentsForASSING1_MEPS_FULL;
   BY memname name;
RUN;
...
CREATE TABLE WORK.SCTABLE AS
	SELECT * FROM WORK.CONTContentsForASSING1_MEPS_FULL
		WHERE memname='ASSING1_MEPS_FULLYR_2012_SAS7';
QUIT;
...
/* -------------------------------------------------------------------
   ...
   Generated on: Wednesday, January 07, 2015 at 3:29:16 PM
